...
function getEventsMeetups(latitude,longitude,radius, page){
...
$allEventsBtn.click(function(){
	//this will render the all the events on the page for the location you choose
	let location = $searchLoc.val();
	if(location){
		$eventPlace.text(location);
	}else{
	...
	getEventsMeetups(coordinates[0],coordinates[1],50,50);
